...
|---|---|---|---|---|
| `v1.1.9` | 1.1.9 | (pending tag) | 2026-07-22 | **Dual-panel cf v1.7.8:** re-list `alibaba-wan-lora` on default compose (drop profile gate); wire studio `MODULE_ALIBABA_WAN_LORA_URL` + depends_on. |
