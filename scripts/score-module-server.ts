...
import { isScoreModuleName, scoreModuleEnvFromProcess } from "../src/modules/score/handlers.js";
...
const env = scoreModuleEnvFromProcess(process.env);
const app = createScoreModuleApp(manifest, moduleName, env);
